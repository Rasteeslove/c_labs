...
int main()
{
    ...
    FILE * conf = fopen("conf.txt", "w");  /* чтобы остановить ввод текста, 
        в этот файл введите ненулевой инт, например 1 
            (я не хотел заканчивать ввод текста парой нажатий enter: 
                так конец ввода не зависит от ввода) */
    fclose(conf);  
